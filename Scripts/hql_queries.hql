...
LOAD DATA INPATH '/user/admin/pageviews/' INTO TABLE april_pageviews;
...
CREATE EXTERNAL TABLE IF NOT EXISTS april_clickstream (
	...
	ROW FORMAT DELIMITED
	FIELDS TERMINATED BY '\t'
	LOCATION '/user/admin/april_clickstream';

LOAD DATA INPATH '/user/admin/clickstream/' INTO TABLE april_clickstream;
